...
if __name__ == '__main__':
    ...
    while time.time() > 1506491443:
        ...
        while time.time() < 1506494452:
            maipiao_result = mai_piao(name=name, sellingPrice='200', activityId='59c9c1890cf277cc1aa25c38',
                                      ticketId='e0c68628e75d43a6a5af65284534ae5f', limitBuyNum='2', sign=sign)
            i = i + 1
            # print(i)1
            if i % 10 == 0:
                print('已经抢票次数:',i)
